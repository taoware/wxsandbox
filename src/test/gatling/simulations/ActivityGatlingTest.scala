...
class ActivityGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Activity entity")
        ...
        .repeat(2) {
            ...
            .put("/api/activitys")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "disable":null, "name":"SAMPLE_TEXT", "indexName":"SAMPLE_TEXT", "folderName":"SAMPLE_TEXT", "type":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "url":"SAMPLE_TEXT", "startDate":"2020-01-01T00:00:00.000Z", "endDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
