...
class OrderGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Order entity")
        ...
        .repeat(2) {
            ...
            .post("/api/orders")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "myString":"SAMPLE_TEXT", "myInteger":"0", "myLong":null, "myFloat":null, "myDouble":null, "myDecimal":null, "myDate":"2020-01-01T00:00:00.000Z", "myDateTime":"2020-01-01T00:00:00.000Z", "myBoolean":null, "myEnumeration":null}""")).asJSON
            .check(status.is(201))
